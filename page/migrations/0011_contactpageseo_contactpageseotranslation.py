# Generated by Django 3.2 on 2024-02-19 17:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('page', '0010_blog_blogcategory_blogcategorytranslation_blogspageseo_blogspageseotranslation_blogtranslation'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ContactPageSeoTranslation',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='page.contactpageseo')),
            ],
            options={
                'verbose_name': 'Contact Page SEO Translation',
                'db_table': 'page_contactpageseo_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
